...
- [Collections](#collections)
  ...
  - [conj](#conj)
  - [some](#some)
  - [dedupe, distinct](#dedupe-distinct)
...
- [Clojure Doc](https://clojuredocs.org/)  - THE reference
- [Clojure Guides](http://clojure-doc.org/)
...
; using keywords, because keywords act as function in this context
...
```clojure
(dedupe [1 2 3 3 3 1 1 6])
=> (1 2 3 1 6)
```
- **distinct** remove any duplicate
```clojure
